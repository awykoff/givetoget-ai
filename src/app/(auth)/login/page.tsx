  ...
  return (
    <main style={{ background: "#0C0C0F", minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", fontFamily: "'DM Sans', -apple-system, BlinkMacSystemFont, sans-serif", padding: "24px" }}>
      ...
      <div style={{ width: "100%", maxWidth: "400px", background: "#18181D", border: "1px solid rgba(255,255,255,0.07)", borderRadius: "14px", padding: "40px 36px" }}>
        <h1 style={{ fontSize: "22px", fontWeight: 700, color: "#F0EEFF", margin: "0 0 8px" }}>Welcome back</h1>
        ...
        <div style={{ marginBottom: "12px" }}>
          <label style={{ display: "block", fontSize: "11px", fontWeight: 600, color: "#8B87A8", marginBottom: "6px", textTransform: "uppercase", letterSpacing: "0.06em" }}>Email</label>
          <input
            type="email"
            value={email}
        ...
        {/* Error */}
        {error && (
          <div style={{ background: "rgba(248,113,113,0.10)", border: "1px solid rgba(248,113,113,0.2)", borderRadius: "7px", padding: "10px 12px", color: "#F87171", fontSize: "12px", marginBottom: "16px" }}>
            {error}
          </div>
        )}
        ...
        <p style={{ fontSize: "12px", color: "#4E4A66", textAlign: "center", margin: "20px 0 0" }}>
          ...
          <a href="/signup" style={{ color: "#C4B5FD", textDecoration: "none", fontWeight: 600 }}>Sign up free</a>
        </p>
      </div>
    </main>
  );
